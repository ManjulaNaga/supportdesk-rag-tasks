...
citation_prompt_template = """Answer the question using the context. Include inline citations [TICK-XXX] after each fact.
...
print("="*80)
# Handle cases where retrieval confidence is low.
...
print("calling smart_rag function...")
smart_rag(
    "How to fix database connection timeouts?",
    vector_store,
    qa_chain
